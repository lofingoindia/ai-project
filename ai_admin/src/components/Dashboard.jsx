              ...
              <div className="categories-toolbar">
                ...
                <div className="categories-toolbar-right">
                  ...
                  <div className="categories-view-toggle">
                    <button 
                      className={`view-toggle-btn ${categoriesViewMode === 'grid' ? 'active' : ''}`}
                    ...
                    <button 
                      className={`view-toggle-btn ${categoriesViewMode === 'list' ? 'active' : ''}`}
          ...
          <div className="products-section">
            ...
            <div className="products-filters">
              ...
              <div className="filter-right">
                ...
                <button 
                  className={`view-toggle-btn grid-view ${productsViewMode === 'grid' ? 'active' : ''}`}
                ...
                <button 
                  className={`view-toggle-btn list-view ${productsViewMode === 'list' ? 'active' : ''}`}
