...
class _SupportPageState extends State<SupportPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final double cardWidth = screenWidth < 500 ? screenWidth * 0.92 : 360;
    final double sectionWidth = screenWidth < 500 ? screenWidth * 0.92 : 320;
    final double horizontalPad = screenWidth < 500 ? 12 : 24;
    final double verticalPad = screenWidth < 500 ? 18 : 32;
    final double fontSizeTitle = screenWidth < 500 ? 19 : 22;
    final double fontSizeBody = screenWidth < 500 ? 13 : 14;
    final double inputPad = screenWidth < 500 ? 10 : 14;
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: screenWidth < 500 ? 10 : 16),
            // Logo and form card
            Center(
              child: Column(
                children: [
            ...
            SizedBox(height: screenWidth < 500 ? 16 : 24),
