import 'package:ai_project_app/pages/my_books_page.dart';
                          ...
                          onPressed: () {
                            showDialog(
                              ...
                              builder: (context) {
                                ...
                                String? dialogError;
                                File? dialogSelectedImage = _selectedImage; // Track dialog's image state
                                                    ...
                                                    Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        ...
                                                        image: dialogSelectedImage != null 
                                                            ? DecorationImage(
                                                                image: FileImage(dialogSelectedImage!),
                                                                fit: BoxFit.cover,
                                                              )
                                                            : _profileImageUrl != null
                                                                ? DecorationImage(
                                                      ...
                                                      child: (dialogSelectedImage == null && _profileImageUrl == null) ? Center(
                                                        child: Text(
                                                          _userName.isNotEmpty 
                                                              ? _userName.substring(0, 1).toUpperCase() + (_userName.length > 1 ? _userName.substring(1, 2).toUpperCase() : 'S')
                                                              : 'US', 
